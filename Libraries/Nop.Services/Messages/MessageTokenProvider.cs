...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        protected virtual string ProductListToHtmlTable(Order order, int languageId, int vendorId)
        {
            ...
            sb.AppendLine("<table class=\"td\" cellspacing=\"0\" cellpadding=\"6\" border=\"1\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;\">");

            //Adding headder
            sb.AppendLine(@"<thead>");
            sb.AppendLine("<tr><th class=\"td\" scope=\"col\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\">Product</th>");
            sb.AppendLine("<th class=\"td\" scope=\"col\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\">Quantity</th>");
            sb.AppendLine("<th class=\"td\" scope=\"col\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\">Price</th>");
            ...
            {
                var si = table[i];
                var orderItem = _orderService.GetOrderItemById(si.Id);
                ...
                sb.AppendLine("<tbody><tr class=\"order_item\">");

                //product name
                var productName = _localizationService.GetLocalized(product, x => x.Name, languageId);
                sb.AppendLine("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; padding: 12px; text-align: left; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; word-wrap: break-word;\">");
                sb.AppendLine(WebUtility.HtmlEncode(productName));
                sb.AppendLine("</td >");

                //Qty
                sb.AppendLine("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; padding: 12px; text-align: left; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;\">");
                sb.AppendLine(si.Quantity.ToString());
                sb.AppendLine("</td >");

                //Price
                sb.AppendLine("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; padding: 12px; text-align: left; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;\">");
                sb.AppendLine(_priceFormatter.FormatPrice(orderItem.PriceExclTax));
                sb.AppendLine("</td >");
            ...
            //Add sub-total
            var subTotal = _priceFormatter.FormatPrice(order.OrderSubtotalExclTax);
            sb.AppendLine("<th class=\"td\" scope=\"row\" colspan=\"2\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left; border-top-width: 4px;\">Subtotal:</th>");
            sb.AppendFormat("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left; border-top-width: 4px;\"><span class=\"woocommerce-Price-amount amount\"><span class=\"woocommerce-Price-currencySymbol\">{0}</span></td>", subTotal);
            sb.AppendLine("</tr>");
            //Shipping cost
            sb.AppendLine("<tr>");
            var shipping = _priceFormatter.FormatPrice(order.OrderShippingInclTax);
            sb.AppendLine("<th class=\"td\" scope=\"row\" colspan=\"2\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\">Shipping Cost:</th>");
            sb.AppendFormat("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\"><span class=\"woocommerce-Price-amount amount\"><span class=\"woocommerce-Price-currencySymbol\">{0}</span></td>", shipping);
            sb.AppendLine("</tr>");
            //Tax display
            var orderTax = _priceFormatter.FormatPrice(order.OrderTax);
            sb.AppendLine("<tr>");
            sb.AppendLine("<th class=\"td\" scope=\"row\" colspan=\"2\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\">Tax (15%):</th>");
            sb.AppendFormat("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\"><span class=\"woocommerce-Price-amount amount\"><span class=\"woocommerce-Price-currencySymbol\">{0}</span></td>", orderTax);
            sb.AppendLine("</tr>");
            sb.AppendLine("<tr>");
            var total = _priceFormatter.FormatPrice(order.PaymentStatus == PaymentStatus.Credit ? (order.OrderTotal * -1) : order.OrderTotal);
            sb.AppendLine("<th class=\"td\" scope=\"row\" colspan=\"2\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\">Total:</th>");
            sb.AppendFormat("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\"><span class=\"woocommerce-Price-amount amount\"><span class=\"woocommerce-Price-currencySymbol\">{0}</span></td>", total);
        ...
        protected virtual string ProductListToHtmlTable(Shipment shipment, int languageId)
        {
            ...
            for (var i = 0; i <= table.Count - 1; i++)
            {
                ...
                //Price
                //sb.AppendLine("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; padding: 12px; text-align: left; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;\">");
                //sb.AppendLine(_priceFormatter.FormatPrice(orderItem.PriceInclTax));
                //sb.AppendLine("</td >");
            ...
            //sb.AppendLine("<tfoot><tr>");
            ////Add sub-total
            //var subTotal = _priceFormatter.FormatPrice(order.OrderSubtotalInclTax);
            //sb.AppendLine("<th class=\"td\" scope=\"row\" colspan=\"2\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left; border-top-width: 4px;\">Subtotal:</th>");
            //sb.AppendFormat("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left; border-top-width: 4px;\"><span class=\"woocommerce-Price-amount amount\"><span class=\"woocommerce-Price-currencySymbol\">{0}</span></td>", subTotal);
            //sb.AppendLine("</tr>");
            ////Shipping cost
            ...
            ////Shipping total cost
            //sb.AppendLine("<tr>");
            //var total = _priceFormatter.FormatPrice(order.OrderTotal);
            //sb.AppendLine("<th class=\"td\" scope=\"row\" colspan=\"2\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\">Total:</th>");
            //sb.AppendFormat("<td class=\"td\" style=\"color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;\"><span class=\"woocommerce-Price-amount amount\"><span class=\"woocommerce-Price-currencySymbol\">{0}</span></td>", total);
            //sb.AppendLine("</tr></tfoot> ");
        ...
        public virtual void AddStoreTokens(IList<Token> tokens, Store store, EmailAccount emailAccount)
        {
            ...
            tokens.Add(new Token("Instgram.URL", _storeInformationSettings.FacebookLink));
