...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// <summary>
        /// Sends Customer an Email for Feedback
        /// </summary>
        /// <param name="customer"></param>
        /// <param name="languageId"></param>
        /// <returns></returns>
        int SendCustomerFeedBackMessage(string sendToEmail, string CustomerName, string body, string subject, List<Token> tokens, int languageId);
        ...
        /// <summary>
        /// Sends s Credit order paid notification to a customer
        /// </summary>
        /// <param name="order">Order instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <param name="attachmentFilePath">Attachment file path</param>
        /// <param name="attachmentFileName">Attachment file name. If specified, then this file name will be sent to a recipient. Otherwise, "AttachmentFilePath" name will be used.</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendCreditOrderCustomerNotification(Order order, int languageId,
            string attachmentFilePath = null, string attachmentFileName = null);
