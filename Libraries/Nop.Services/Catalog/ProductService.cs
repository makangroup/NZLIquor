...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        protected readonly IProfitMarkupsService _profitMarkupsService;
        #endregion
        ...
        public virtual Product GetProductById(int productId)
        {
            ...
            var product = _productRepository.ToCachedGetById(productId);

            //If corporate customer and profit markup is defined then calculate the price.
            if (_workContext.IsCorporateCustomer)
            {
                ...
                if (profitMarkup != null)
                {
                    ...
                    product.Price = product.ProductCost + profit;
                }
            }
