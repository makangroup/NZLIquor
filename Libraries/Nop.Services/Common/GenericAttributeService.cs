...
namespace Nop.Services.Common
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        public virtual GenericAttribute GetAttribute(int entityId, string key, string keyGroup)
        {
            if (entityId == 0 || string.IsNullOrEmpty(key) || string.IsNullOrEmpty(keyGroup))
                return null;

            var query = from o in _genericAttributeRepository.Table
