...
namespace Nop.Services.Common
{
    ...
    {
        void PrintShippingSlipsToPdf(Stream stream, IList<Shipment> shipments, int languageId = 0);
        ...
        void PrintPicklistToPdf(Stream stream, IList<Order> orders, int languageId = 0, int vendorId = 0);
