    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallMessageTemplates()
        {
            ...
            var messageTemplates = new List<MessageTemplate>
            {
                ...
                new MessageTemplate
                {
                  ...
                  new MessageTemplate
                {
                    Name = MessageTemplateSystemNames.AboutUsMessage,
                    Subject = "%Store.Name%. About us",
                    Body = $"<p>{Environment.NewLine}%AboutUs.Body%{Environment.NewLine}</p>{Environment.NewLine}",
                    IsActive = true,
                    EmailAccountId = eaGeneral.Id
                },
                 new MessageTemplate
                {
                    Name = MessageTemplateSystemNames.FeedBackMessage,
                    Subject = "%Store.Name%. Feedback",
                    Body = $"<p>{Environment.NewLine}%FeedBack.Body%{Environment.NewLine}</p>{Environment.NewLine}",
                    IsActive = true,
                    EmailAccountId = eaGeneral.Id
                },
                new MessageTemplate
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new PdfSettings
            {
                ...
                FontFileName = "Gotham-Medium.ttf",
            ...
            settingService.SaveSetting(new CommonSettings
            {
                ...
                UseSystemEmailForAboutUsForm = true,
                UseSystemEmailForFeedBackForm = true,
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                InstagramLink = "http://instagram.com/nopCommerce",
            ...
            settingService.SaveSetting(new ShippingSettings
            {
                ...
                FreeShippingNormalCustomerOverXValue = decimal.Zero,
            ...
            settingService.SaveSetting(new DisplayDefaultMenuItemSettings
            {
                ...
                DisplayAboutUsMenuItem = true,
                DisplayFeedBackMenuItem = true
            });
            ...
            settingService.SaveSetting(new DisplayDefaultFooterItemSettings
            {
                ...
                DisplayAboutUsFooterItem = true,
                DisplayFeedBackFooterItem = true,
        ...
        protected virtual void InstallActivityLogTypes()
        {
            var activityLogTypes = new List<ActivityLogType>
            {
                ...
                new ActivityLogType
                {
                   ...
                   new ActivityLogType
                {
                    SystemKeyword = "PublicStore.AboutUs",
                    Enabled = false,
                    Name = "Public store. Use about us form"
                },
                  new ActivityLogType
                {
                    SystemKeyword = "PublicStore.FeedBack",
                    Enabled = false,
                    Name = "Public store. Use feed back form"
                },
                new ActivityLogType
                {
        ...
        public virtual void InstallSampleData(string defaultUserEmail)
        {
            ...
            settingService.SaveSetting(new DisplayDefaultMenuItemSettings
            {
                ...
                DisplayAboutUsMenuItem = false,
                DisplayFeedBackMenuItem = false
            });
        }
