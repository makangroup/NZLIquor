...
namespace Nop.Services.Orders
{
    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
            ...
            out int? maximumDiscountQty)
        {
            ...
            else if(_profitMarkupsService.GetProductPrice(_workContext.CurrentCustomer.Id, shoppingCartItem.ProductId, out price))
            {
                subTotal = price * shoppingCartItem.Quantity;
            }
            else
            {
                subTotal = unitPrice * shoppingCartItem.Quantity;
