...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderProcessingService
    {
        ...
        /// <summary>
        /// This method is used to process the order payment and returns the successfully process order ids. 
        /// </summary>
        /// <param name="response">Successfully process order ids</param>
        IEnumerable<int> ProcessCreditOrderPayment(string response);
        ...
        void ProcessCreditOrder(Order order);
