...
namespace Nop.Services.Orders
{
    ...
    {
        #region Orders
        decimal GetCreditOrdersTotal(Customer customer, int[] orderIds);
        ...
        public IPagedList<Order> SearchOverDueOrders(DateTime? createdFromUtc = null, 
        ...
        decimal GetCustomerOverDueAmount(int customerId);
