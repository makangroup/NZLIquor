...
namespace Nop.Core.Domain.Shipping
{
    ...
    public class ShippingSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value of 'Free shipping over X' option for normal customers
        /// </summary>
        public decimal FreeShippingNormalCustomerOverXValue { get; set; }

        /// <summary>
        /// Get or set a value of 'Free shipping over X' option for corporate customers
        /// </summary>
        public decimal FreeShippingCorporateCustomerOverXValue { get; set; }
