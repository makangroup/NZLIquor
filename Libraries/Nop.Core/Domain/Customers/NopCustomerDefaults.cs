namespace Nop.Core.Domain.Customers
{
    ...
    public static partial class NopCustomerDefaults
    {
        ...
        public static string CustomerNoteAttribute => "CustomerNote";
        ...
        public static string Avatar2PictureIdAttribute => "Avatar2PictureId";

        public static string CustomerIdentification => "CustomerIdentification";
