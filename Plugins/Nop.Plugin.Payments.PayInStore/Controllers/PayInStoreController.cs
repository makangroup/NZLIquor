...
namespace Nop.Plugin.Payments.PayInStore.Controllers
{
    ...
    public class PayInStoreController : BasePaymentController
    {
        #region Fields
        ...
        public PayInStoreController(ILanguageService languageService,
        ...
        public IActionResult Configure()
        {
            ...
            AddLocales(_languageService, model.Locales, (locale, languageId) =>
            {
                locale.DescriptionText = _localizationService
                    .GetLocalizedSetting(payInStorePaymentSettings, x => x.DescriptionText, languageId, 0, false, false);
            });
            ...
            model.ShippableProductRequired = payInStorePaymentSettings.ShippableProductRequired;
            ...
            if (storeScope > 0)
            {
                ...
                model.ShippableProductRequired_OverrideForStore = _settingService.SettingExists(payInStorePaymentSettings, x => x.ShippableProductRequired, storeScope);
            }
        ...
        public IActionResult Configure(ConfigurationModel model)
        {
            ...
            //load settings for a chosen store scope
            var storeScope = _storeContext.ActiveStoreScopeConfiguration;
            var checkMoneyOrderPaymentSettings = _settingService.LoadSetting<PayInStorePaymentSettings>(storeScope);
