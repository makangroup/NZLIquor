...
namespace Nop.Plugin.Payments.Credit
{
    /// <summary>
    /// CheckMoneyOrder payment processor
    /// </summary>
    public class CreditPaymentProcessor : BasePlugin, IPaymentMethod
    {
        #region Fields
        ...
        public CreditPaymentProcessor(CreditPaymentSettings checkMoneyOrderPaymentSettings,
        ...
        {
            return new ProcessPaymentResult() { NewPaymentStatus = Core.Domain.Payments.PaymentStatus.Credit };
        }
        ...
        {
            //If the user is a corporate customer then dispaly the credit Payment option
            if (_workContext.IsCorporateCustomer)
                return false;
        ...
        {
            //settings
            _settingService.DeleteSetting<CreditPaymentSettings>();
