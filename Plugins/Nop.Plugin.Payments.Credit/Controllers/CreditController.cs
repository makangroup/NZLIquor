...
using Nop.Core;
using Nop.Plugin.Payments.Credit.Models;
...
namespace Nop.Plugin.Payments.Credit.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    [AutoValidateAntiforgeryToken]
    public class CreditController : BasePaymentController
    {
        #region Fields
        ...
        public CreditController(ILanguageService languageService,
        ...
        public IActionResult Configure()
        {
            ...
            var checkMoneyOrderPaymentSettings = _settingService.LoadSetting<CreditPaymentSettings>(storeScope);
