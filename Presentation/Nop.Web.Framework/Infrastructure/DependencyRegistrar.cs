...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<CorporateCustomerService>().As<ICorporateCustomerService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<CorporateCustomerTypeService>().As<ICorporateCustomerTypeService>().InstancePerLifetimeScope();
            builder.RegisterType<WindcavePaymentService>().As<IWindcavePaymentService>().InstancePerLifetimeScope();
            builder.RegisterType<CreditOrderPaymentService>().As<ICreditOrderPaymentService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<ProfitMarkupsService>().As<IProfitMarkupsService>().InstancePerLifetimeScope();
