...
namespace Nop.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private bool? _isCorporateCustomer; 
        ...
        /// <summary>
        /// Get whetehr the current custoemr is a corporate customer
        /// </summary>

        public bool IsCorporateCustomer
        {
            get
            {
                if (_isCorporateCustomer.HasValue)
                    return _isCorporateCustomer.Value;

                var copCust = _corporateCustomerService.GetCustomerById(CurrentCustomer.Id);
                if (copCust != null)
                    _isCorporateCustomer = true;
                else
                    _isCorporateCustomer = false;
