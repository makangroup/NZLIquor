...
namespace Nop.Web.Controllers
{
    ...
    public partial class CommonController : BasePublicController
    {
        ...
        [CheckAccessClosedStore(true)]
        public virtual IActionResult FeedBack()
        {
           var model = new FeedBackModel();
            model = _commonModelFactory.PrepareFeedBackModel(model, false);
            return View();
        }
        ...
        //available even when a store is closed
        [CheckAccessClosedStore(true)]
        public virtual IActionResult FeedBackSend(FeedBackModel model, bool captchaValid)
        {
            //validate CAPTCHA
            if (_captchaSettings.Enabled && _captchaSettings.ShowOnFeedBackPage && !captchaValid)
            {
                ModelState.AddModelError("", _localizationService.GetResource("Common.WrongCaptchaMessage"));
            }

            model = _commonModelFactory.PrepareFeedBackModel(model, true);
        ...
        public virtual IActionResult AboutUs()
        {
            ...
            model = _commonModelFactory.PrepareAboutUsModel(model, false);
            return View();
        }
        [HttpPost, ActionName("AboutUs")]
        [ValidateCaptcha]
        //available even when a store is closed
        [CheckAccessClosedStore(true)]
        public virtual IActionResult AboutUsSend(AboutUsModel model, bool captchaValid)
        {
            //validate CAPTCHA
            if (_captchaSettings.Enabled && _captchaSettings.ShowOnAboutUsPage && !captchaValid)
            {
                ModelState.AddModelError("", _localizationService.GetResource("Common.WrongCaptchaMessage"));
            }

            model = _commonModelFactory.PrepareAboutUsModel(model, true);
