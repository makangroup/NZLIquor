...
using System.Linq;
using System.Text;
using Fenchurch.Web.Models.Common;
...
namespace Nop.Web.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual ShoppingCartHeader PrepareShoppingCartHeaderModel()
        {
            var customer = _workContext.CurrentCustomer;
            ...
            var model = new ShoppingCartHeader
            {
                IsAuthenticated = _customerService.IsRegistered(customer),
                CustomerName = _customerService.IsRegistered(customer) ? _customerService.FormatUsername(customer) : string.Empty,
                ShoppingCartEnabled = _permissionService.Authorize(StandardPermissionProvider.EnableShoppingCart),
        ...
        public virtual FooterModel PrepareFooterModel()
        {
            ...
            var model = new FooterModel
            {
                ...
                DisplayAboutUsFooterItem = _displayDefaultFooterItemSettings.DisplayAboutUsFooterItem,
                DisplayFeedBackFooterItem = _displayDefaultFooterItemSettings.DisplayFeedBackFooterItem,
        ...
        public virtual AboutUsModel PrepareAboutUsModel(AboutUsModel model, bool excludeProperties)
        {
            //if (model == null)
            //    throw new ArgumentNullException(nameof(model));
            ...
            //model.SubjectEnabled = _commonSettings.SubjectFieldOnFeedBackForm;
            //model.DisplayCaptcha = _captchaSettings.Enabled && _captchaSettings.ShowOnFeedBackPage;

            return model;
        }
        public virtual FeedBackModel PrepareFeedBackModel(FeedBackModel model, bool excludeProperties)
        {
            //if (model == null)
            //    throw new ArgumentNullException(nameof(model));
        ...
        public virtual SitemapModel PrepareSitemapModel(SitemapPageModel pageModel)
        {
            ...
            var cachedModel = _staticCacheManager.Get(cacheKey, () =>
            {
                ...
                {
                    GroupTitle = commonGroupTitle,
                    Name = _localizationService.GetResource("AboutUs"),
                    Url = urlHelper.RouteUrl("AboutUs")
                });
                //feedback
                model.Items.Add(new SitemapModel.SitemapItemModel
                {
                    GroupTitle = commonGroupTitle,
                    Name = _localizationService.GetResource("FeedBack"),
                    Url = urlHelper.RouteUrl("FeedBack")
                });
