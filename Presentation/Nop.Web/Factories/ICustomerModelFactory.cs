...
namespace Nop.Web.Factories
{
    ...
    public partial interface ICustomerModelFactory
    {
        ...
        /// <summary>
        /// Prepare the Corporate Customer Payments
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        public CorporateCustomerPaymentsModel PrepareCorporateCustomerPayments(CorporateCustomerPaymentsModel model, Customer customer);

        /// <summary>
        /// Prepare Corporate Customer Credit Payment List
        /// </summary>
        /// <param name="FromDate"></param>
        /// <param name="ToDate"></param>
        /// <param name="Customer"></param>
        /// <returns></returns>
        List<OrderDetailsModel> PrepareCorporateCustomerCreditPaymentList(DateTime FromDate, DateTime ToDate, Customer Customer);
        ...
        CorporateCustomerRegistrationModel PrepareCorporateCustomerRegistrationModel(CorporateCustomerRegistrationModel model, bool excludeProperties,
            string overrideCustomCustomerAttributesXml = "", bool setDefaultValues = false);
    }
}
