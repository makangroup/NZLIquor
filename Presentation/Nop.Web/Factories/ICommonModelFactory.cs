...
namespace Nop.Web.Factories
{
    ...
    public partial interface ICommonModelFactory
    {
        ...
        ShoppingCartHeader PrepareShoppingCartHeaderModel();
        /// <summary>
        ...
        AboutUsModel PrepareAboutUsModel(AboutUsModel model, bool excludeProperties);
        FeedBackModel PrepareFeedBackModel(FeedBackModel model, bool excludeProperties);
