...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateCustomersMaps()
        {
            ...
            CreateMap<CorporateCustomer, Fenchurch.Web.Models.Customer.CorporateCustomerModel>()
               .ForMember(model => model.AccountNo, options => options.Ignore())
               .ForMember(model => model.AccountsContact, options => options.Ignore())
               .ForMember(model => model.AccountsEmailAddress, options => options.Ignore())
               .ForMember(model => model.AccountsToBeEmailed, options => options.Ignore())
               .ForMember(model => model.AccountTermsEnum, options => options.Ignore())
               .ForMember(model => model.Bank, options => options.Ignore())
               .ForMember(model => model.Branch, options => options.Ignore())
               .ForMember(model => model.CompanyNo, options => options.Ignore())
               .ForMember(model => model.CreditLimtRequired, options => options.Ignore())
               .ForMember(model => model.CustomerTypeEnum, options => options.Ignore())
               .ForMember(model => model.Customer_Id, options => options.Ignore())
               .ForMember(model => model.DateIncorporated, options => options.Ignore())
               .ForMember(model => model.DateOfBirth, options => options.Ignore())
               .ForMember(model => model.DriversLicenceNo, options => options.Ignore())
               .ForMember(model => model.EstimatedMonthlyPurchase, options => options.Ignore())
               .ForMember(model => model.GSTNo, options => options.Ignore())
               .ForMember(model => model.LiquoredCompanyNo, options => options.Ignore())
               .ForMember(model => model.LiquoredDateLeasedFrom, options => options.Ignore())
               .ForMember(model => model.LiquoredDateLeasedTo, options => options.Ignore())
               .ForMember(model => model.LiquoredFacsimilieNumber, options => options.Ignore())
               .ForMember(model => model.LiquoredFullNameLicensee, options => options.Ignore())
               .ForMember(model => model.LiquoredLandlordName, options => options.Ignore())
               .ForMember(model => model.LiquoredLicenceExpiryDate, options => options.Ignore())
               .ForMember(model => model.LiquoredLicenceNo, options => options.Ignore())
               .ForMember(model => model.LiquoredPhone, options => options.Ignore())
               .ForMember(model => model.LiquoredPostCode, options => options.Ignore())
               .ForMember(model => model.LiquoredPreviousLicenceDetails, options => options.Ignore())
               .ForMember(model => model.LiquoredStreet, options => options.Ignore())
               .ForMember(model => model.LiquoredSuburb, options => options.Ignore())
               .ForMember(model => model.LiquoredTobaccoLicenceExpiryDate, options => options.Ignore())
               .ForMember(model => model.LiquoredTobaccoLicenceNo, options => options.Ignore())
               .ForMember(model => model.NatureOfBusiness, options => options.Ignore())
               .ForMember(model => model.PaidUpCapital, options => options.Ignore())
               .ForMember(model => model.PhoneNo, options => options.Ignore())
               .ForMember(model => model.PrincipalPlaceOfBusinessEnum, options => options.Ignore())
               .ForMember(model => model.PurchaseOrderRequired, options => options.Ignore());


            CreateMap<Fenchurch.Web.Models.Customer.CorporateCustomerModel, CorporateCustomer>()
               .ForMember(entity => entity.AccountNo, options => options.Ignore())
               .ForMember(entity => entity.AccountsContact, options => options.Ignore())
               .ForMember(entity => entity.AccountsEmailAddress, options => options.Ignore())
               .ForMember(entity => entity.AccountsToBeEmailed, options => options.Ignore())
               .ForMember(entity => entity.AccountTerms, options => options.Ignore())
               .ForMember(entity => entity.Bank, options => options.Ignore())
               .ForMember(entity => entity.Branch, options => options.Ignore())
               .ForMember(entity => entity.CompanyNo, options => options.Ignore())
               .ForMember(entity => entity.CreditLimtRequired, options => options.Ignore())
               .ForMember(entity => entity.CustomerType, options => options.Ignore())
               .ForMember(entity => entity.Customer_Id, options => options.Ignore())
               .ForMember(entity => entity.DateIncorporated, options => options.Ignore())
               .ForMember(entity => entity.DateOfBirth, options => options.Ignore())
               .ForMember(entity => entity.DriversLicenceNo, options => options.Ignore())
               .ForMember(entity => entity.EstimatedMonthlyPurchase, options => options.Ignore())
               .ForMember(entity => entity.GSTNo, options => options.Ignore())
               .ForMember(entity => entity.LiquoredCompanyNo, options => options.Ignore())
               .ForMember(entity => entity.LiquoredDateLeasedFrom, options => options.Ignore())
               .ForMember(entity => entity.LiquoredDateLeasedTo, options => options.Ignore())
               .ForMember(entity => entity.LiquoredFacsimilieNumber, options => options.Ignore())
               .ForMember(entity => entity.LiquoredFullNameLicensee, options => options.Ignore())
               .ForMember(entity => entity.LiquoredLandlordName, options => options.Ignore())
               .ForMember(entity => entity.LiquoredLicenceExpiryDate, options => options.Ignore())
               .ForMember(entity => entity.LiquoredLicenceNo, options => options.Ignore())
               .ForMember(entity => entity.LiquoredPhone, options => options.Ignore())
               .ForMember(entity => entity.LiquoredPostCode, options => options.Ignore())
               .ForMember(entity => entity.LiquoredPreviousLicenceDetails, options => options.Ignore())
               .ForMember(entity => entity.LiquoredStreet, options => options.Ignore())
               .ForMember(entity => entity.LiquoredSuburb, options => options.Ignore())
               .ForMember(entity => entity.LiquoredTobaccoLicenceExpiryDate, options => options.Ignore())
               .ForMember(entity => entity.LiquoredTobaccoLicenceNo, options => options.Ignore())
               .ForMember(entity => entity.NatureOfBusiness, options => options.Ignore())
               .ForMember(entity => entity.PaidUpCapital, options => options.Ignore())
               .ForMember(entity => entity.PhoneNo, options => options.Ignore())
               .ForMember(entity => entity.PrincipalPlaceOfBusiness, options => options.Ignore())
               .ForMember(entity => entity.PurchaseOrderRequired, options => options.Ignore());
        ...
        protected virtual void CreateProfitMarkupMaps()
        {
            CreateMap<CorporateCustomerProfitMarkups, ProfitMarkupsModel>()
                .ForMember(model => model.CorporateCustomerTypes, options => options.Ignore())
                .ForMember(model => model.ProductCategories, options => options.Ignore())
                .ForMember(model => model.ProductCategorie, options => options.Ignore())
                .ForMember(model => model.CorporateCustomerTypeName, options => options.Ignore())
                .ForMember(model => model.ProfitMarkups, options => options.Ignore());
            CreateMap<ProfitMarkupsModel, CorporateCustomerProfitMarkups>();
        }
        ...
        protected virtual void CreateSecurityMaps()
        {
            CreateMap<CaptchaSettings, CaptchaSettingsModel>()
                ...
                .ForMember(model => model.ShowOnContactUsPage_OverrideForStore, options => options.Ignore())
                 .ForMember(model => model.ShowOnAboutUsPage_OverrideForStore, options => options.Ignore())
                .ForMember(model => model.ShowOnFeedBackPage_OverrideForStore, options => options.Ignore())
