    ...
    public partial class SettingModelFactory : ISettingModelFactory
    {
        ...
        protected virtual StoreInformationSettingsModel PrepareStoreInformationSettingsModel()
        {
            ...
            var model = new StoreInformationSettingsModel
            {
                ...
                SubjectFieldOnAboutUsForm = commonSettings.SubjectFieldOnAboutUsForm,
                UseSystemEmailForAboutUsForm = commonSettings.UseSystemEmailForAboutUsForm,
                SubjectFieldOnFeedBackForm = commonSettings.SubjectFieldOnFeedBackForm,
                UseSystemEmailForFeedBackForm = commonSettings.UseSystemEmailForFeedBackForm,
            ...
            model.SubjectFieldOnAboutUsForm_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.SubjectFieldOnAboutUsForm, storeId);
            model.UseSystemEmailForAboutUsForm_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.UseSystemEmailForAboutUsForm, storeId);

            model.SubjectFieldOnFeedBackForm_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.SubjectFieldOnFeedBackForm, storeId);
            model.UseSystemEmailForFeedBackForm_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.UseSystemEmailForFeedBackForm, storeId);
        ...
        protected virtual CaptchaSettingsModel PrepareCaptchaSettingsModel()
        {
            ...
            model.ShowOnAboutUsPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnAboutUsPage, storeId);
            model.ShowOnFeedBackPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnFeedBackPage, storeId);
        ...
        protected virtual DisplayDefaultMenuItemSettingsModel PrepareDisplayDefaultMenuItemSettingsModel()
        {
            ...
            var model = new DisplayDefaultMenuItemSettingsModel
            {
                ...
                DisplayAboutUsMenuItem = displayDefaultMenuItemSettings.DisplayAboutUsMenuItem,
                DisplayFeedBackMenuItem = displayDefaultMenuItemSettings.DisplayFeedBackMenuItem
            };
            ...
            model.DisplayAboutUsMenuItem_OverrideForStore = _settingService.SettingExists(displayDefaultMenuItemSettings, x => x.DisplayAboutUsMenuItem, storeId);

            model.DisplayFeedBackMenuItem_OverrideForStore = _settingService.SettingExists(displayDefaultMenuItemSettings, x => x.DisplayFeedBackMenuItem, storeId);
        ...
        protected virtual DisplayDefaultFooterItemSettingsModel PrepareDisplayDefaultFooterItemSettingsModel()
        {
            ...
            var model = new DisplayDefaultFooterItemSettingsModel
            {
                ...
                DisplayAboutUsFooterItem = displayDefaultFooterItemSettings.DisplayAboutUsFooterItem,
                DisplayFeedBackFooterItem = displayDefaultFooterItemSettings.DisplayFeedBackFooterItem,
            ...
            model.DisplayAboutUsFooterItem_OverrideForStore = _settingService.SettingExists(displayDefaultFooterItemSettings, x => x.DisplayAboutUsFooterItem, storeId);

            model.DisplayFeedBackFooterItem_OverrideForStore = _settingService.SettingExists(displayDefaultFooterItemSettings, x => x.DisplayFeedBackFooterItem, storeId);
        ...
        public virtual ShippingSettingsModel PrepareShippingSettingsModel()
        {
            ...
            if (storeId > 0)
            {
                ...
                model.FreeShippingOverXValue_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.FreeShippingNormalCustomerOverXValue, storeId);
                model.FreeShippingOverXValue_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.FreeShippingCorporateCustomerOverXValue, storeId);
