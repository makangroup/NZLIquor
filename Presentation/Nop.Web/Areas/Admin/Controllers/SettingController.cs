...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        public virtual IActionResult Shipping(ShippingSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(shippingSettings, x => x.FreeShippingNormalCustomerOverXValue, model.FreeShippingOverXValue_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(shippingSettings, x => x.FreeShippingCorporateCustomerOverXValue, model.FreeShippingOverXValue_OverrideForStore, storeScope, false);
        ...
        public virtual IActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            //about us
            commonSettings.SubjectFieldOnAboutUsForm = model.StoreInformationSettings.SubjectFieldOnAboutUsForm;
            commonSettings.UseSystemEmailForAboutUsForm = model.StoreInformationSettings.UseSystemEmailForAboutUsForm;
            //feedback
            commonSettings.SubjectFieldOnFeedBackForm = model.StoreInformationSettings.SubjectFieldOnFeedBackForm;
            commonSettings.UseSystemEmailForFeedBackForm = model.StoreInformationSettings.UseSystemEmailForFeedBackForm;
            //terms of service
            ...
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.SubjectFieldOnAboutUsForm, model.StoreInformationSettings.SubjectFieldOnAboutUsForm_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.UseSystemEmailForAboutUsForm, model.StoreInformationSettings.UseSystemEmailForAboutUsForm_OverrideForStore, storeScope, false);

            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.SubjectFieldOnFeedBackForm, model.StoreInformationSettings.SubjectFieldOnFeedBackForm_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.UseSystemEmailForFeedBackForm, model.StoreInformationSettings.UseSystemEmailForFeedBackForm_OverrideForStore, storeScope, false);
            ...
            captchaSettings.ShowOnAboutUsPage = model.CaptchaSettings.ShowOnAboutUsPage;
            captchaSettings.ShowOnFeedBackPage = model.CaptchaSettings.ShowOnFeedBackPage;
            ...
            _settingService.SaveSettingOverridablePerStore(captchaSettings, x => x.ShowOnFeedBackPage, model.CaptchaSettings.ShowOnFeedBackPage_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(captchaSettings, x => x.ShowOnAboutUsPage, model.CaptchaSettings.ShowOnAboutUsPage_OverrideForStore, storeScope, false);
            ...
            displayDefaultMenuItemSettings.DisplayAboutUsMenuItem = model.DisplayDefaultMenuItemSettings.DisplayAboutUsMenuItem;
            displayDefaultMenuItemSettings.DisplayFeedBackMenuItem = model.DisplayDefaultMenuItemSettings.DisplayFeedBackMenuItem;
            ...
            displayDefaultFooterItemSettings.DisplayAboutUsFooterItem = model.DisplayDefaultFooterItemSettings.DisplayAboutUsFooterItem;
            displayDefaultFooterItemSettings.DisplayFeedBackFooterItem = model.DisplayDefaultFooterItemSettings.DisplayFeedBackFooterItem;
            ...
            _settingService.SaveSettingOverridablePerStore(displayDefaultFooterItemSettings, x => x.DisplayAboutUsFooterItem, model.DisplayDefaultFooterItemSettings.DisplayAboutUsFooterItem_OverrideForStore, storeScope, false);

            _settingService.SaveSettingOverridablePerStore(displayDefaultFooterItemSettings, x => x.DisplayFeedBackFooterItem, model.DisplayDefaultFooterItemSettings.DisplayFeedBackFooterItem_OverrideForStore, storeScope, false);
