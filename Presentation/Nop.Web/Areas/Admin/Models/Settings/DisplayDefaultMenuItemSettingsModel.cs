...
namespace Nop.Web.Areas.Admin.Models.Settings
{
    ...
    public partial class DisplayDefaultMenuItemSettingsModel : BaseNopModel, ISettingsModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.DisplayDefaultMenuItemSettings.DisplayAboutUsMenuItem")]
        public bool DisplayAboutUsMenuItem { get; set; }
        public bool DisplayAboutUsMenuItem_OverrideForStore { get; set; }


        [NopResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.DisplayDefaultMenuItemSettings.DisplayFeedBackMenuItem")]
        public bool DisplayFeedBackMenuItem { get; set; }
        public bool DisplayFeedBackMenuItem_OverrideForStore { get; set; }
