...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            //corporatecutomerregister
            endpointRouteBuilder.MapControllerRoute("CorporateCustomer", $"{pattern}CorporateCustomer/Register",
                new { controller = "Customer", action = "CorporateCustomerRegistration" });
            ...
            //customer account links
            endpointRouteBuilder.MapControllerRoute("CustomerPayments", $"{pattern}customer/payments",
                new { controller = "Customer", action = "Payments" });
            ...
            //feedback
            endpointRouteBuilder.MapControllerRoute("FeedBack", $"{pattern}feedback",
            ...
            //Coprporate register result page 2
            endpointRouteBuilder.MapControllerRoute("CorporateRegisterResult",
                pattern + "corporateregisterresult/{resultId:min(0)}",
                new { controller = "Customer", action = "CorporateRegisterResult" });

            //Coprporate register result page final
            endpointRouteBuilder.MapControllerRoute("CorporateRegisterResultFinal",
                pattern + "corporateregisterresultfinal/{resultId:min(0)}",
                new { controller = "Customer", action = "CorporateCustomerFinalResult" });
