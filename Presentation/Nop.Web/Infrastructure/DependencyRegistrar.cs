...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<CorporateCustomerModelFactory>().As<ICorporateCustomerModelFactory>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<RequestOutputFactory>().As<IRequestOutputFactory>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<ProfitMarkupModelFactory>().As<IProfitMarkupModelFactory>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<Fenchurch.Web.Factories.MessageSchedularFactory>().As<Fenchurch.Web.Factories.IMessageSchedularFactory>().InstancePerLifetimeScope();
        }
